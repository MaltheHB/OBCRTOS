// ======================================================================
// Watchdog.v generated from TopDesign.cysch
// 04/25/2022 at 13:46
...
module top ;
	...
	wire [0:0] tmpOE__arduino_in_net;
	wire [0:0] tmpIO_0__arduino_in_net;
	wire [0:0] tmpINTERRUPT_0__arduino_in_net;
	electrical [0:0] tmpSIOVREF__arduino_in_net;
	...
	cy_psoc3_pins_v1_10
		...
		arduino_in
		 (.oe(tmpOE__arduino_in_net),
		  .y({1'b0}),
		  .fb({Net_150}),
		  .io({tmpIO_0__arduino_in_net[0:0]}),
		  .siovref(tmpSIOVREF__arduino_in_net),
		  .interrupt({tmpINTERRUPT_0__arduino_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__arduino_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Arduino_out1_net;
	wire [0:0] tmpFB_0__Arduino_out1_net;
	wire [0:0] tmpIO_0__Arduino_out1_net;
	wire [0:0] tmpINTERRUPT_0__Arduino_out1_net;
	electrical [0:0] tmpSIOVREF__Arduino_out1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Arduino_out1
		 (.oe(tmpOE__Arduino_out1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Arduino_out1_net[0:0]}),
		  .io({tmpIO_0__Arduino_out1_net[0:0]}),
		  .siovref(tmpSIOVREF__Arduino_out1_net),
		  .interrupt({tmpINTERRUPT_0__Arduino_out1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Arduino_out1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("1f2a95b8-a049-44b9-a586-abb9f65ed456"),
		  .source_clock_id("315365C3-2E3E-4f04-84A2-BB564A173261"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
	...
	wire [0:0] tmpOE__COMout_net;
	wire [0:0] tmpFB_0__COMout_net;
	wire [0:0] tmpIO_0__COMout_net;
	wire [0:0] tmpINTERRUPT_0__COMout_net;
	electrical [0:0] tmpSIOVREF__COMout_net;

	cy_psoc3_pins_v1_10
		#(.id("95212ad3-5183-44ad-94c2-08085b16e7af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		COMout
		 (.oe(tmpOE__COMout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__COMout_net[0:0]}),
		  .io({tmpIO_0__COMout_net[0:0]}),
		  .siovref(tmpSIOVREF__COMout_net),
		  .interrupt({tmpINTERRUPT_0__COMout_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COMout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__COMin_net;
	wire [0:0] tmpIO_0__COMin_net;
	wire [0:0] tmpINTERRUPT_0__COMin_net;
	electrical [0:0] tmpSIOVREF__COMin_net;

	cy_psoc3_pins_v1_10
		#(.id("ca4e2d78-5c98-4e92-9c04-e59f0239872d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		COMin
		 (.oe(tmpOE__COMin_net),
		  .y({1'b0}),
		  .fb({Net_160}),
		  .io({tmpIO_0__COMin_net[0:0]}),
		  .siovref(tmpSIOVREF__COMin_net),
		  .interrupt({tmpINTERRUPT_0__COMin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COMin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
